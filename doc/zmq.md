...
The ZeroMQ feature in hera requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ herad -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/herad.tx.raw
...
From the perspective of herad, the ZeroMQ socket is write-only; PUB
