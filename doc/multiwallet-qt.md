...
In order to support loading of multiple wallets in hera-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hera.cpp.
...
Changes to hera.cpp
----------------------
hera.cpp is the entry point into hera-qt, and as such, will require some minor modifications to provide hooks for
