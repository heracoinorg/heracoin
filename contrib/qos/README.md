...
This means one can have an always-on herad instance running, and another local herad/hera-qt instance which connects to this node and receives blocks from it.
