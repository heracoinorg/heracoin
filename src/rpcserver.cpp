...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* hera features */
        {"hera", "masternode", &masternode, true, true, false},
        {"hera", "listmasternodes", &listmasternodes, true, true, false},
        {"hera", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hera", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hera", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"hera", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"hera", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"hera", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hera", "masternodedebug", &masternodedebug, true, true, false},
        {"hera", "startmasternode", &startmasternode, true, true, false},
        {"hera", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hera", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hera", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hera", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hera", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hera", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hera", "mnbudget", &mnbudget, true, true, false},
        {"hera", "preparebudget", &preparebudget, true, true, false},
        {"hera", "submitbudget", &submitbudget, true, true, false},
        {"hera", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hera", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hera", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hera", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hera", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hera", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hera", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hera", "checkbudgets", &checkbudgets, true, true, false},
        {"hera", "mnsync", &mnsync, true, true, false},
        {"hera", "spork", &spork, true, true, false},
        {"hera", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> hera-cli " + methodname + " " + args + "\n";
}
