...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::hera);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeheraAmount"))
        SoftSetArg("-anonymizeheraamount", settings.value("nAnonymizeheraAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in hera.cpp during shotdown to also remove the window positions
