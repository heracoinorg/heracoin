                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HERA Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&hera Project"), this);
    webmainAction->setStatusTip(tr("hera Project Website"));
    ...
    facebookAction->setStatusTip(tr("hera Facebook"));
    ...
    twitterAction->setStatusTip(tr("hera Twitter"));
    ...
    discordAction->setStatusTip(tr("hera Discord"));
    ...
    youtubeAction->setStatusTip(tr("hera Youtube"));
    ...
    telegramAction->setStatusTip(tr("hera Telegram"));
    ...
    redditAction->setStatusTip(tr("hera Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap hera"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell hera Coin (hera)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    heraBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&hera block explorer"), this);
    heraBlockExplorerAction->setStatusTip(tr("hera blockchain explorer"));
    heraBlockExplorerAction->setToolTip(heraBlockExplorerAction->statusTip());
    heraBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&hera Project Github"), this);
    githubAction->setStatusTip(tr("hera Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a hera address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hera: URIs)"));
...
//    }
    ...
    connect(heraBlockExplorerAction, SIGNAL(triggered()), this, SLOT(heraBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About hera Core"), this);
    aboutAction->setStatusTip(tr("Show information about hera Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for hera"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your hera addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified hera addresses"));
    ...
    openAction->setStatusTip(tr("Open a hera: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the hera Core help message to get a list with possible hera command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(heraBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("hera Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.hera.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/hera.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/hera4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/heracryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/hera-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::heraBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/hera/hera/"));
}
...
{
    QString strTitle = tr("hera Core"); // default title
