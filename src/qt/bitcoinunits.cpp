...
QString BitcoinUnits::id(int unit)
{
    ...
    case hera:
        return QString("HERA");
    case mECA:
        return QString("mHERA");
    case uECA:
        return QString::fromUtf8("uHERA");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case hera:
            return QString("tHERA");
        case mECA:
            return QString("mtHERA");
        case uECA:
            return QString::fromUtf8("μtHERA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case hera:
            return QString("HERA");
        case mECA:
            return QString("Milli-HERA (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-HERA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case hera:
            return QString("TestHERA");
        case mECA:
            return QString("Milli-TestHERA (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestHERA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
