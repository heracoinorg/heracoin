...
/* hera GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "hera"
#define QAPP_ORG_DOMAIN "heraproject.org"
#define QAPP_APP_NAME_DEFAULT "hera-Qt"
#define QAPP_APP_NAME_TESTNET "hera-Qt-testnet"
