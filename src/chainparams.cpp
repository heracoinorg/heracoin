...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 5 * 150; // 2.5 minutes
        nTargetSpacing = 150; // 2.5 seconds
        nMaturity = 10;
        ...
        const char* pszTimestamp = "hera is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1623721099;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 11525964;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa7310e1696e5c75bc45ee9e63b510daee8ee40e75c218ff8a51a18e1a6fd5efb"));
        assert(hashGenesisBlock == uint256("0x000001650812ffed0c0320a4008dd450576708a1fbdee9df435c269bc5292c3c"));

     
	vSeeds.push_back(CDNSSeedData("165.22.12.211","165.22.12.211"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa7310e1696e5c75bc45ee9e63b510daee8ee40e75c218ff8a51a18e1a6fd5efb"));
        assert(hashGenesisBlock == uint256("0x00002ae7aafe4d4b354af89b849db8c10332ee2516fba38d68b3c6902ca205b5"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xa7310e1696e5c75bc45ee9e63b510daee8ee40e75c218ff8a51a18e1a6fd5efb"));
        assert(hashGenesisBlock == uint256("0x1351a79e4030145e1bd8fd1c4af55c56845bb8e1a20f3bcea1ae5db01ec03a68"));
